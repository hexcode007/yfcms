...
namespace GuzzleHttp\Tests\Ring\Client {
    ...
    class CurlFactoryTest extends \PHPUnit_Framework_TestCase {
        ...
        public function testCreatesCurlHandle() {
            ...
            $this->assertEquals(
                    'http://http://127.0.0.1:8125/', $_SERVER['_curl'][CURLOPT_URL]
            );
            ...
            if (defined('CURLOPT_PROTOCOLS')) {
                $this->assertEquals(
                        CURLPROTO_HTTP | CURLPROTO_HTTPS, $_SERVER['_curl'][CURLOPT_PROTOCOLS]
                );
            }
        ...
        public function testFailsWhenNoResponseAndNoBody() {
            ...
            $this->assertContains(
                    'No response was received for a request with no body', $res['error']->getMessage()
            );
        }
        ...
        public function testFailsWhenCannotRewindRetry() {
            ...
            $this->assertInstanceOf('GuzzleHttp\Ring\Exception\RingException', $res['error']);
            $this->assertContains(
                    'rewind the request body failed', $res['error']->getMessage()
            );
        }
        ...
        public function testFailsWhenRetryMoreThanThreeTimes() {
            ...
            $this->assertContains(
                    'The cURL request was retried 3 times', $response['error']->getMessage()
            );
        }
        ...
        public function testMaintainsMultiHeaderOrder() {
            ...
            $this->assertEquals(
                    ['a', 'b', 'c', 'd'], Core::headerLines($response, 'Foo')
            );
        }
