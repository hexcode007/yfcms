...
class StreamHandlerTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testAddsErrorToResponse() {
        ...
        $this->assertInstanceOf(
                'GuzzleHttp\Ring\Exception\RingException', $result['error']
        );
    }
    ...
    public function testEnsuresTheHttpProtocol() {
        ...
        $this->assertContains(
                'URL is invalid: ftp://localhost:123', $result['error']->getMessage()
        );
    }
    ...
    public function testVerifiesVerifyIsValidIfPath() {
        ...
        $this->assertContains(
                'SSL CA bundle not found: /does/not/exist', (string) $res['error']
        );
    }
    ...
    public function testVerifiesCertIfValidPath() {
        ...
        $this->assertContains(
                'SSL certificate not found: /does/not/exist', (string) $res['error']
        );
    }
    ...
    public function testEnsuresVerifyOptionIsValid() {
        ...
        $this->assertContains(
                'Invalid verify request option', (string) $res['error']
        );
    }
    ...
    public function testEnsuresThatStreamContextIsAnArray() {
        ...
        $this->assertContains(
                'stream_context must be an array', (string) $res['error']
        );
    }
