...
class StreamHandler {
    ...
    $url, array $request, &$http_response_header
    ) {
        static $methods;
        if (!$methods) {
        ...
        return $this->createStreamResource(
                        $url, $request, $options, $this->createContext($request, $options, $params), $http_response_header
        );
    }
    ...
    $url, array $request, array $options, $context, &$http_response_header
    ) {
        return $this->createResource(
