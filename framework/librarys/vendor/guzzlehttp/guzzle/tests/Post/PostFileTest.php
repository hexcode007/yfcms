...
class PostFileTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testCreatesFromString() {
        ...
        $this->assertEquals(
                'form-data; name="foo"; filename="test.php"', $p->getHeaders()['Content-Disposition']
        );
    }
    ...
    public function testCreatesFromMultipartFormData() {
        ...
        $this->assertEquals(
                'form-data; name="foo"', $p->getHeaders()['Content-Disposition']
        );
        $this->assertEquals(
                'multipart/form-data; boundary=baz', $p->getHeaders()['Content-Type']
        );
    }
