...
class MessageFactoryTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testCreatesRequestWithPostBodyScalars() {
        ...
        $this->assertEquals(
                'abc=1&123=&foo&baz=10&bam=1.5&boo%5B0%5D=1', (string) $req->getBody()
        );
    }
    ...
    public function testCanForceMultipartUploadWithContentType() {
        ...
        $this->assertContains(
                'multipart/form-data; boundary=', $history->getLastRequest()->getHeader('Content-Type')
        );
        $this->assertContains(
