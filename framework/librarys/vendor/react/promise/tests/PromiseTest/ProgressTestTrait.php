...
trait ProgressTestTrait {
    ...
    public function progressShouldPropagateProgressToDownstreamPromises() {
        ...
        $adapter->promise()
                ->then(
                        $this->expectCallableNever(), $this->expectCallableNever(), $mock
                )
                ->then(
                        $this->expectCallableNever(), $this->expectCallableNever(), $mock2
        );
    ...
    public function progressShouldAllowResolveAfterProgress() {
        ...
        $adapter->promise()
                ->then(
                        $mock, $this->expectCallableNever(), $mock
        );
    ...
    public function progressShouldAllowRejectAfterProgress() {
        ...
        $adapter->promise()
                ->then(
                        $this->expectCallableNever(), $mock, $mock
        );
